...
const NewInvite = () => {
  ...
  return (
    <div className="w-full max-w-[579px] min-h-[182px] rounded-[28.5px] bg-[#282828] pt-[14px] pb-[24px] pl-[32px] pr-[115px]">
      ...
      <div className="flex justify-start items-center gap-4 mt-[21px]">
        <div className=" flex gap-2 items-center w-[292px] h-[41px] bg-[#00000029] rounded-[28.5px] pl-[14px] pr-6">
